...
class ClanPanelCog(commands.Cog):
    ...
    async def on_interaction(self, interaction: discord.Interaction):
        ...
        # 1) Select -> open application modal immediately
        ...
        # 2) Finalize -> mention review role + show review panel
        ...
        if isinstance(custom_id, str) and custom_id.startswith("clan_review|"):
            ...
            if action == "accept":
                ...
                move_err = None
                try:
                    move_ok = await _move_ticket_to_clan_category(ticket_channel, clan_value)
                except discord.Forbidden:
                ...
                if move_ok:
                    container.add_item(discord.ui.TextDisplay(content="**Přesun do clan kategorie:** OK"))
                else:
